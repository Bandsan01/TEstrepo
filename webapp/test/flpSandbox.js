		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Order Display",
									"targetURL": "#comappzuicalodrdisplay-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comappzuicalodrdisplay-display": {
								"semanticObject": "comappzuicalodrdisplay",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.app.zuicalodrdisplay",
									"url": sap.ui.require.toUrl("com/app/zuicalodrdisplay")
								}
							}
						}
					}
